...
android {
    compileSdk = 35
    namespace = "code.name.monkey.pulsemusic"
    ...
    defaultConfig {
        ...
        manifestPlaceholders["redirectSchemeName"] = "pulse"
    ...
    val signingProperties = getProperties("Pulse.properties")
