...
import code.name.monkey.pulsemusic.activities.ErrorActivity
import code.name.monkey.pulsemusic.activities.MainActivity
import code.name.monkey.pulsemusic.appshortcuts.DynamicShortcutManager
import code.name.monkey.pulsemusic.billing.BillingManager
import code.name.monkey.pulsemusic.helper.WallpaperAccentManager
