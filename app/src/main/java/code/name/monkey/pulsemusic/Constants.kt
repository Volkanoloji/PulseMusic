...
object Constants {
    ...
    const val RATE_ON_GOOGLE_PLAY =
        "https://play.google.com/store/apps/details?id=code.name.monkey.pulsemusic"
    const val TRANSLATE = "https://crowdin.com/project/Pulsemusicplayer"
    const val WEBSITE = "https://Pulsemusic.app"
    const val GITHUB_PROJECT = "https://github.com/PulseMusicPlayer/PulseMusicPlayer"
    const val TELEGRAM_CHANGE_LOG = "https://t.me/Pulsemusiclog"
    const val USER_PROFILE = "profile.jpg"
    const val USER_BANNER = "banner.jpg"
    const val APP_TELEGRAM_LINK = "https://t.me/Pulsemusicapp/"
    const val APP_TWITTER_LINK = "https://twitter.com/Pulsemusicapp"
    const val FAQ_LINK = "https://github.com/PulseMusicPlayer/PulseMusicPlayer/blob/master/FAQ.md"
    const val PINTEREST = "https://in.pinterest.com/Pulsemusicapp/"
