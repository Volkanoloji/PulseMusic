...
import code.name.monkey.pulsemusic.databinding.FragmentWhatsNewBinding
import code.name.monkey.pulsemusic.extensions.accentColor
import code.name.monkey.pulsemusic.extensions.openUrl
import code.name.monkey.pulsemusic.util.PreferenceUtil.lastVersion
...
class WhatsNewFragment : BottomSheetDialogFragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        try {
            ...
            val stream = requireContext().assets.open("Pulse-changelog.html")
