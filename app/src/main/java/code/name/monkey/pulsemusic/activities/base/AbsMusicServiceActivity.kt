...
import code.name.monkey.pulsemusic.db.toPlayCount
...
import code.name.monkey.pulsemusic.service.MusicService.Companion.FAVORITE_STATE_CHANGED
import code.name.monkey.pulsemusic.service.MusicService.Companion.MEDIA_STORE_CHANGED
import code.name.monkey.pulsemusic.service.MusicService.Companion.META_CHANGED
import code.name.monkey.pulsemusic.service.MusicService.Companion.PLAY_STATE_CHANGED
import code.name.monkey.pulsemusic.service.MusicService.Companion.QUEUE_CHANGED
import code.name.monkey.pulsemusic.service.MusicService.Companion.REPEAT_MODE_CHANGED
import code.name.monkey.pulsemusic.service.MusicService.Companion.SHUFFLE_MODE_CHANGED
import code.name.monkey.pulsemusic.util.PreferenceUtil
import code.name.monkey.pulsemusic.util.logD
