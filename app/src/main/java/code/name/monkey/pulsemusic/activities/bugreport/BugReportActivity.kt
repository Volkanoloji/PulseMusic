...
package code.name.monkey.pulsemusic.activities.bugreport
...
import code.name.monkey.pulsemusic.activities.bugreport.model.DeviceInfo
import code.name.monkey.pulsemusic.databinding.ActivityBugReportBinding
...
open class BugReportActivity : AbsThemeActivity() {
    ...
    companion object {
        private const val ISSUE_TRACKER_LINK =
            "https://github.com/PulseMusicPlayer/PulseMusicPlayer/issues"
    }
}
