...
import code.name.monkey.pulsemusic.databinding.ActivityAlbumTagEditorBinding
...
import code.name.monkey.pulsemusic.util.RetroColorUtil.generatePalette
import code.name.monkey.pulsemusic.util.RetroColorUtil.getColor
