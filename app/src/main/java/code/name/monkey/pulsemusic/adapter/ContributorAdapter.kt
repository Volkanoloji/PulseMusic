...
import code.name.monkey.pulsemusic.model.Contributor
import code.name.monkey.pulsemusic.views.PulseShapeableImageView
...
class ContributorAdapter(
    ...
    inner class ViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        ...
        val image: PulseShapeableImageView = itemView.findViewById(R.id.icon)
