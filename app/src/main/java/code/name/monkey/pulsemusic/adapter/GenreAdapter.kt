...
import code.name.monkey.pulsemusic.databinding.ItemGenreBinding
...
class GenreAdapter(
    ...
    private fun loadGenreImage(genre: Genre, holder: GenreAdapter.ViewHolder) {
        ...
        Glide.with(activity)
            ...
            .load(PulseGlideExtension.getSongModel(genreSong))
            .into(object : PulseMusicColoredTarget(holder.binding.image) {
