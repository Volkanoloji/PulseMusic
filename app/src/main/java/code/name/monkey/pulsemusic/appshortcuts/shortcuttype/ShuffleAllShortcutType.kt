...
package code.name.monkey.pulsemusic.appshortcuts.shortcuttype
...
import code.name.monkey.pulsemusic.appshortcuts.AppShortcutIconGenerator
import code.name.monkey.pulsemusic.appshortcuts.AppShortcutLauncherActivity
