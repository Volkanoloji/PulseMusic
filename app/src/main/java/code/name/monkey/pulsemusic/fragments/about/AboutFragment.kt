...
package code.name.monkey.pulsemusic.fragments.about
...
import code.name.monkey.pulsemusic.adapter.ContributorAdapter
import code.name.monkey.pulsemusic.databinding.FragmentAboutBinding
