...
package code.name.monkey.pulsemusic.fragments.albums
...
import code.name.monkey.pulsemusic.EXTRA_ARTIST_NAME
import code.name.monkey.pulsemusic.R
import code.name.monkey.pulsemusic.activities.tageditor.AbsTagEditorActivity
import code.name.monkey.pulsemusic.activities.tageditor.AlbumTagEditorActivity
import code.name.monkey.pulsemusic.adapter.album.HorizontalAlbumAdapter
import code.name.monkey.pulsemusic.adapter.song.SimpleSongAdapter
import code.name.monkey.pulsemusic.databinding.FragmentAlbumDetailsBinding
...
import code.name.monkey.pulsemusic.glide.PulseGlideExtension.artistImageOptions
import code.name.monkey.pulsemusic.glide.PulseGlideExtension.asBitmapPalette
import code.name.monkey.pulsemusic.glide.SingleColorTarget
import code.name.monkey.pulsemusic.helper.MusicPlayerRemote
import code.name.monkey.pulsemusic.helper.SortOrder.AlbumSongSortOrder.Companion.SONG_A_Z
import code.name.monkey.pulsemusic.helper.SortOrder.AlbumSongSortOrder.Companion.SONG_DURATION
import code.name.monkey.pulsemusic.helper.SortOrder.AlbumSongSortOrder.Companion.SONG_TRACK_LIST
import code.name.monkey.pulsemusic.helper.SortOrder.AlbumSongSortOrder.Companion.SONG_Z_A
...
import code.name.monkey.pulsemusic.network.model.LastFmAlbum
import code.name.monkey.pulsemusic.repository.RealRepository
import code.name.monkey.pulsemusic.util.*
...
class AlbumDetailsFragment : AbsMainActivityFragment(R.layout.fragment_album_details),
        ...
        if (lastFmAlbum.album != null) {
            ...
            if (lastFmAlbum.album.listeners.isNotEmpty()) {
                ...
                binding.fragmentAlbumContent.listeners.text =
                    PulseUtil.formatValue(lastFmAlbum.album.listeners.toFloat())
                binding.fragmentAlbumContent.scrobbles.text =
                    PulseUtil.formatValue(lastFmAlbum.album.playcount.toFloat())
            }
        }
    }
    ...
    private fun loadArtistImage(artist: Artist) {
        ...
        Glide.with(requireContext())
            ...
            .load(
                PulseGlideExtension.getArtistModel(
                    artist,
