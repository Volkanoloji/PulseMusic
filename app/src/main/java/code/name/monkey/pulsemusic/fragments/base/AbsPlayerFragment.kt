...
package code.name.monkey.pulsemusic.fragments.base
...
import code.name.monkey.pulsemusic.activities.MainActivity
...
import code.name.monkey.pulsemusic.dialogs.PlaybackSpeedDialog
import code.name.monkey.pulsemusic.dialogs.SleepTimerDialog
import code.name.monkey.pulsemusic.dialogs.SongDetailDialog
import code.name.monkey.pulsemusic.dialogs.SongShareDialog
import code.name.monkey.pulsemusic.extensions.currentFragment
import code.name.monkey.pulsemusic.extensions.getTintedDrawable
import code.name.monkey.pulsemusic.extensions.hide
import code.name.monkey.pulsemusic.extensions.keepScreenOn
...
import code.name.monkey.pulsemusic.util.NavigationUtil
