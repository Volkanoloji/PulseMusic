...
package code.name.monkey.pulsemusic.fragments.genres
...
import code.name.monkey.pulsemusic.EXTRA_GENRE
import code.name.monkey.pulsemusic.R
import code.name.monkey.pulsemusic.adapter.GenreAdapter
...
import code.name.monkey.pulsemusic.fragments.base.AbsRecyclerViewFragment
import code.name.monkey.pulsemusic.interfaces.IGenreClickListener
...
GenresFragment : AbsRecyclerViewFragment<GenreAdapter, LinearLayoutManager>(),
    ...
    override fun createLayoutManager(): LinearLayoutManager {
        return if (PulseUtil.isLandscape) {
