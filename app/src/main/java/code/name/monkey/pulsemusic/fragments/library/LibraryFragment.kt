...
package code.name.monkey.pulsemusic.fragments.library
...
import code.name.monkey.pulsemusic.databinding.FragmentLibraryBinding
...
class LibraryFragment : AbsMainActivityFragment(R.layout.fragment_library) {
    ...
    private fun setupTitle() {
        ...
        val appName = "Pulse <span  style='color:$hexColor';>Music</span>".parseAsHtml()
