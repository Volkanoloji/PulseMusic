...
package code.name.monkey.pulsemusic.fragments.lyrics
...
import code.name.monkey.pulsemusic.lyrics.LrcView
import code.name.monkey.pulsemusic.R
import code.name.monkey.pulsemusic.activities.tageditor.TagWriter
import code.name.monkey.pulsemusic.databinding.FragmentLyricsBinding
...
import code.name.monkey.pulsemusic.model.AudioTagInfo
import code.name.monkey.pulsemusic.model.Song
import code.name.monkey.pulsemusic.util.FileUtils
import code.name.monkey.pulsemusic.util.LyricUtil
import code.name.monkey.pulsemusic.util.UriUtil
