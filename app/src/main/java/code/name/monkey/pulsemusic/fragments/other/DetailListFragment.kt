...
import code.name.monkey.pulsemusic.adapter.album.AlbumAdapter
import code.name.monkey.pulsemusic.adapter.artist.ArtistAdapter
import code.name.monkey.pulsemusic.adapter.song.ShuffleButtonSongAdapter
import code.name.monkey.pulsemusic.adapter.song.SongAdapter
import code.name.monkey.pulsemusic.databinding.FragmentPlaylistDetailBinding
import code.name.monkey.pulsemusic.db.toSong
...
import code.name.monkey.pulsemusic.interfaces.IArtistClickListener
...
class DetailListFragment : AbsMainActivityFragment(R.layout.fragment_playlist_detail),
    ...
    private fun gridCount(): Int {
        if (PulseUtil.isTablet) {
            return if (PulseUtil.isLandscape) 6 else 4
        }
        return if (PulseUtil.isLandscape) 4 else 2
    }
