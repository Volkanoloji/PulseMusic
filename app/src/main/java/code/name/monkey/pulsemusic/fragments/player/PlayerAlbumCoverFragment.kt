...
package code.name.monkey.pulsemusic.fragments.player
...
import code.name.monkey.pulsemusic.adapter.album.AlbumCoverPagerAdapter
import code.name.monkey.pulsemusic.adapter.album.AlbumCoverPagerAdapter.AlbumCoverFragment
import code.name.monkey.pulsemusic.databinding.FragmentPlayerAlbumCoverBinding
import code.name.monkey.pulsemusic.extensions.isColorLight
...
import code.name.monkey.pulsemusic.fragments.base.goToLyrics
...
import code.name.monkey.pulsemusic.lyrics.CoverLrcView
import code.name.monkey.pulsemusic.model.lyrics.Lyrics
import code.name.monkey.pulsemusic.transform.CarousalPagerTransformer
import code.name.monkey.pulsemusic.transform.ParallaxPagerTransformer
import code.name.monkey.pulsemusic.util.CoverLyricsType
import code.name.monkey.pulsemusic.util.LyricUtil
