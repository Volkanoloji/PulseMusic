...
package code.name.monkey.pulsemusic.fragments.player.adaptive
...
import code.name.monkey.pulsemusic.databinding.FragmentAdaptivePlayerPlaybackControlsBinding
