...
package code.name.monkey.pulsemusic.fragments.player.cardblur
...
import code.name.monkey.pulsemusic.databinding.FragmentCardBlurPlayerBinding
...
import code.name.monkey.pulsemusic.util.PreferenceUtil.blurAmount
