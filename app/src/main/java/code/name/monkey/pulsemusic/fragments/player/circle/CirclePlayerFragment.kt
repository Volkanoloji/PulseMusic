...
package code.name.monkey.pulsemusic.fragments.player.circle
...
import code.name.monkey.pulsemusic.databinding.FragmentCirclePlayerBinding
...
import code.name.monkey.pulsemusic.glide.PulseGlideExtension.simpleSongCoverOptions
import code.name.monkey.pulsemusic.glide.crossfadeListener
...
class CirclePlayerFragment : AbsPlayerFragment(R.layout.fragment_circle_player), Callback,
    ...
    private fun updateSong() {
        ...
        Glide.with(this)
            .load(PulseGlideExtension.getSongModel(MusicPlayerRemote.currentSong))
