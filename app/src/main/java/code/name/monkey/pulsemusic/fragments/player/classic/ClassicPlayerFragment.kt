...
package code.name.monkey.pulsemusic.fragments.player.classic
...
import code.name.monkey.pulsemusic.databinding.FragmentClassicPlayerBinding
import code.name.monkey.pulsemusic.extensions.*
import code.name.monkey.pulsemusic.fragments.MusicSeekSkipTouchListener
import code.name.monkey.pulsemusic.fragments.base.AbsPlayerControlsFragment
...
import code.name.monkey.pulsemusic.misc.SimpleOnSeekbarChangeListener
