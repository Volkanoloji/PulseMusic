...
package code.name.monkey.pulsemusic.fragments.player.full
...
import code.name.monkey.pulsemusic.databinding.FragmentFullBinding
            ...
            .observe(viewLifecycleOwner) { artist ->
                if (artist.id != -1L) {
                    Glide.with(requireActivity())
                        .load(PulseGlideExtension.getArtistModel(artist))
