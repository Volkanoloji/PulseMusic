...
package code.name.monkey.pulsemusic.fragments.player.gradient
...
import code.name.monkey.pulsemusic.adapter.song.PlayingQueueAdapter
import code.name.monkey.pulsemusic.databinding.FragmentGradientPlayerBinding
import code.name.monkey.pulsemusic.extensions.applyColor
import code.name.monkey.pulsemusic.extensions.drawAboveSystemBars
import code.name.monkey.pulsemusic.extensions.getBottomInsets
import code.name.monkey.pulsemusic.extensions.getSongInfo
import code.name.monkey.pulsemusic.extensions.hide
import code.name.monkey.pulsemusic.extensions.ripAlpha
import code.name.monkey.pulsemusic.extensions.show
import code.name.monkey.pulsemusic.extensions.whichFragment
import code.name.monkey.pulsemusic.fragments.MusicSeekSkipTouchListener
import code.name.monkey.pulsemusic.fragments.base.AbsPlayerFragment
import code.name.monkey.pulsemusic.fragments.base.goToAlbum
import code.name.monkey.pulsemusic.fragments.base.goToArtist
import code.name.monkey.pulsemusic.fragments.other.VolumeFragment
import code.name.monkey.pulsemusic.fragments.player.CoverLyricsFragment
