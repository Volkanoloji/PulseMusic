...
package code.name.monkey.pulsemusic.fragments.player.lockscreen
...
import code.name.monkey.pulsemusic.databinding.FragmentLockScreenPlaybackControlsBinding
