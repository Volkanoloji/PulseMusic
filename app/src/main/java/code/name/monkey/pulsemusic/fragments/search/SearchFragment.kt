...
package code.name.monkey.pulsemusic.fragments.search
...
import code.name.monkey.pulsemusic.adapter.SearchAdapter
import code.name.monkey.pulsemusic.databinding.FragmentSearchBinding
