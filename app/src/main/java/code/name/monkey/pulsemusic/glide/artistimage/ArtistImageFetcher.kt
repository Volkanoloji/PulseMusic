...
import code.name.monkey.pulsemusic.model.Data
import code.name.monkey.pulsemusic.model.DeezerResponse
import code.name.monkey.pulsemusic.network.DeezerService
