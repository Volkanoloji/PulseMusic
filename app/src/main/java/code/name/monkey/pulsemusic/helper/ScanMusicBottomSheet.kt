...
import code.name.monkey.pulsemusic.databinding.BottomSheetScanMusicBinding
...
import code.name.monkey.pulsemusic.fragments.folder.ScanResult
import code.name.monkey.pulsemusic.fragments.folder.ScanViewModel
