...
package code.name.monkey.pulsemusic.preferences
...
import code.name.monkey.pulsemusic.databinding.PreferenceDialogNowPlayingScreenBinding
import code.name.monkey.pulsemusic.databinding.PreferenceNowPlayingScreenItemBinding
