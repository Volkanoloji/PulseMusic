...
import code.name.monkey.pulsemusic.service.MusicService.Companion.ACTION_PAUSE
import code.name.monkey.pulsemusic.service.MusicService.Companion.ACTION_PLAY
import code.name.monkey.pulsemusic.service.MusicService.Companion.ACTION_REWIND
import code.name.monkey.pulsemusic.service.MusicService.Companion.ACTION_SKIP
import code.name.monkey.pulsemusic.service.MusicService.Companion.ACTION_STOP
import code.name.monkey.pulsemusic.service.MusicService.Companion.ACTION_TOGGLE_PAUSE
        ...
        private fun acquireWakeLockAndSendMessage(context: Context, msg: Message, delay: Long) {
            if (wakeLock == null) {
                ...
                wakeLock = pm?.newWakeLock(
                    ...
                    "PulseMusicApp:Wakelock headset button"
                )
