 ...
 */
package code.name.monkey.pulsemusic.service
...
import code.name.monkey.pulsemusic.BuildConfig
...
import code.name.monkey.pulsemusic.activities.LockScreenActivity
import code.name.monkey.pulsemusic.appwidgets.AppWidgetBig
import code.name.monkey.pulsemusic.appwidgets.AppWidgetCard
import code.name.monkey.pulsemusic.appwidgets.AppWidgetCircle
import code.name.monkey.pulsemusic.appwidgets.AppWidgetClassic
import code.name.monkey.pulsemusic.appwidgets.AppWidgetMD3
import code.name.monkey.pulsemusic.appwidgets.AppWidgetSmall
import code.name.monkey.pulsemusic.appwidgets.AppWidgetText
import code.name.monkey.pulsemusic.auto.AutoMediaIDHelper
import code.name.monkey.pulsemusic.auto.AutoMusicProvider
import code.name.monkey.pulsemusic.extensions.showToast
import code.name.monkey.pulsemusic.extensions.toMediaSessionQueue
import code.name.monkey.pulsemusic.extensions.uri
import code.name.monkey.pulsemusic.glide.BlurTransformation
import code.name.monkey.pulsemusic.glide.PulseGlideExtension.getSongModel
import code.name.monkey.pulsemusic.glide.PulseGlideExtension.songCoverOptions
import code.name.monkey.pulsemusic.helper.ShuffleHelper.makeShuffleList
import code.name.monkey.pulsemusic.model.Song
import code.name.monkey.pulsemusic.model.Song.Companion.emptySong
import code.name.monkey.pulsemusic.model.smartplaylist.AbsSmartPlaylist
import code.name.monkey.pulsemusic.providers.HistoryStore
import code.name.monkey.pulsemusic.providers.MusicPlaybackQueueStore
import code.name.monkey.pulsemusic.providers.SongPlayCountStore
import code.name.monkey.pulsemusic.service.notification.PlayingNotification
import code.name.monkey.pulsemusic.service.playback.Playback
import code.name.monkey.pulsemusic.service.playback.Playback.PlaybackCallbacks
import code.name.monkey.pulsemusic.util.MusicUtil
import code.name.monkey.pulsemusic.util.MusicUtil.toggleFavorite
import code.name.monkey.pulsemusic.util.PackageValidator
import code.name.monkey.pulsemusic.util.PreferenceUtil.crossFadeDuration
import code.name.monkey.pulsemusic.util.PreferenceUtil.isAlbumArtOnLockScreen
import code.name.monkey.pulsemusic.util.PreferenceUtil.isBluetoothSpeaker
import code.name.monkey.pulsemusic.util.PreferenceUtil.isBlurredAlbumArt
import code.name.monkey.pulsemusic.util.PreferenceUtil.isHeadsetPlugged
import code.name.monkey.pulsemusic.util.PreferenceUtil.isLockScreen
import code.name.monkey.pulsemusic.util.PreferenceUtil.isPauseOnZeroVolume
import code.name.monkey.pulsemusic.util.PreferenceUtil.playbackPitch
import code.name.monkey.pulsemusic.util.PreferenceUtil.playbackSpeed
import code.name.monkey.pulsemusic.util.PreferenceUtil.registerOnSharedPreferenceChangedListener
import code.name.monkey.pulsemusic.util.PreferenceUtil.unregisterOnSharedPreferenceChangedListener
import code.name.monkey.pulsemusic.volume.AudioVolumeObserver
import code.name.monkey.pulsemusic.volume.OnAudioVolumeChangedListener
...
class MusicService : MediaBrowserServiceCompat(),
    ...
    fun updateMediaSessionMetaData(onCompletion: () -> Unit) {
        ...
        if (isAlbumArtOnLockScreen || VersionUtils.hasT()) {
            // val screenSize: Point = PulseUtil.getScreenSize(this)
    ...
    companion object {
        ...
        const val retro_MUSIC_PACKAGE_NAME = "code.name.monkey.pulsemusic"
