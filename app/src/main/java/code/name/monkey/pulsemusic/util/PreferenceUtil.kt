...
import code.name.monkey.pulsemusic.ADAPTIVE_COLOR_APP
import code.name.monkey.pulsemusic.ALBUM_ARTISTS_ONLY
import code.name.monkey.pulsemusic.ALBUM_ART_ON_LOCK_SCREEN
import code.name.monkey.pulsemusic.ALBUM_COVER_STYLE
import code.name.monkey.pulsemusic.ALBUM_COVER_TRANSFORM
import code.name.monkey.pulsemusic.ALBUM_DETAIL_SONG_SORT_ORDER
import code.name.monkey.pulsemusic.ALBUM_GRID_SIZE
import code.name.monkey.pulsemusic.ALBUM_GRID_SIZE_LAND
import code.name.monkey.pulsemusic.ALBUM_GRID_STYLE
import code.name.monkey.pulsemusic.ALBUM_SONG_SORT_ORDER
import code.name.monkey.pulsemusic.ALBUM_SORT_ORDER
import code.name.monkey.pulsemusic.APPBAR_MODE
import code.name.monkey.pulsemusic.ARTIST_ALBUM_SORT_ORDER
import code.name.monkey.pulsemusic.ARTIST_DETAIL_SONG_SORT_ORDER
import code.name.monkey.pulsemusic.ARTIST_GRID_SIZE
import code.name.monkey.pulsemusic.ARTIST_GRID_SIZE_LAND
import code.name.monkey.pulsemusic.ARTIST_GRID_STYLE
import code.name.monkey.pulsemusic.ARTIST_SONG_SORT_ORDER
import code.name.monkey.pulsemusic.ARTIST_SORT_ORDER
import code.name.monkey.pulsemusic.AUDIO_FADE_DURATION
import code.name.monkey.pulsemusic.AUTO_DOWNLOAD_IMAGES_POLICY
import code.name.monkey.pulsemusic.App
import code.name.monkey.pulsemusic.BLACK_THEME
import code.name.monkey.pulsemusic.BLUETOOTH_PLAYBACK
import code.name.monkey.pulsemusic.BLURRED_ALBUM_ART
import code.name.monkey.pulsemusic.CAROUSEL_EFFECT
import code.name.monkey.pulsemusic.CIRCLE_PLAY_BUTTON
import code.name.monkey.pulsemusic.COLORED_APP_SHORTCUTS
import code.name.monkey.pulsemusic.CROSS_FADE_DURATION
import code.name.monkey.pulsemusic.CUSTOM_FONT
import code.name.monkey.pulsemusic.DESATURATED_COLOR
import code.name.monkey.pulsemusic.ENABLE_SEARCH_PLAYLIST
import code.name.monkey.pulsemusic.EXPAND_NOW_PLAYING_PANEL
import code.name.monkey.pulsemusic.EXTRA_SONG_INFO
import code.name.monkey.pulsemusic.FILTER_SONG
import code.name.monkey.pulsemusic.GENERAL_THEME
import code.name.monkey.pulsemusic.GENRE_SORT_ORDER
import code.name.monkey.pulsemusic.HOME_ALBUM_GRID_STYLE
import code.name.monkey.pulsemusic.HOME_ARTIST_GRID_STYLE
import code.name.monkey.pulsemusic.IGNORE_MEDIA_STORE_ARTWORK
import code.name.monkey.pulsemusic.INITIALIZED_BLACKLIST
import code.name.monkey.pulsemusic.KEEP_SCREEN_ON
import code.name.monkey.pulsemusic.LANGUAGE_NAME
import code.name.monkey.pulsemusic.LAST_ADDED_CUTOFF
import code.name.monkey.pulsemusic.LAST_CHANGELOG_VERSION
import code.name.monkey.pulsemusic.LAST_DIRECTORY
import code.name.monkey.pulsemusic.LAST_SLEEP_TIMER_VALUE
import code.name.monkey.pulsemusic.LAST_USED_TAB
import code.name.monkey.pulsemusic.LIBRARY_CATEGORIES
import code.name.monkey.pulsemusic.LOCALE_AUTO_STORE_ENABLED
import code.name.monkey.pulsemusic.LOCK_SCREEN
import code.name.monkey.pulsemusic.LYRICS_OPTIONS
import code.name.monkey.pulsemusic.LYRICS_TYPE
import code.name.monkey.pulsemusic.MANAGE_AUDIO_FOCUS
import code.name.monkey.pulsemusic.MATERIAL_YOU
import code.name.monkey.pulsemusic.NEW_BLUR_AMOUNT
import code.name.monkey.pulsemusic.NEXT_SLEEP_TIMER_ELAPSED_REALTIME
import code.name.monkey.pulsemusic.NOW_PLAYING_SCREEN_ID
import code.name.monkey.pulsemusic.PAUSE_HISTORY
import code.name.monkey.pulsemusic.PAUSE_ON_ZERO_VOLUME
import code.name.monkey.pulsemusic.PLAYBACK_PITCH
import code.name.monkey.pulsemusic.PLAYBACK_SPEED
import code.name.monkey.pulsemusic.PLAYLIST_GRID_SIZE
import code.name.monkey.pulsemusic.PLAYLIST_GRID_SIZE_LAND
import code.name.monkey.pulsemusic.PLAYLIST_SORT_ORDER
import code.name.monkey.pulsemusic.R
import code.name.monkey.pulsemusic.RECENTLY_PLAYED_CUTOFF
import code.name.monkey.pulsemusic.REMEMBER_LAST_TAB
import code.name.monkey.pulsemusic.SAF_SDCARD_URI
import code.name.monkey.pulsemusic.SAVE_LAST_DIRECTORY
import code.name.monkey.pulsemusic.SCREEN_ON_LYRICS
import code.name.monkey.pulsemusic.SHOW_LYRICS
import code.name.monkey.pulsemusic.SHOW_WHEN_LOCKED
import code.name.monkey.pulsemusic.SLEEP_TIMER_FINISH_SONG
import code.name.monkey.pulsemusic.SNOWFALL
import code.name.monkey.pulsemusic.SONG_GRID_SIZE
import code.name.monkey.pulsemusic.SONG_GRID_SIZE_LAND
import code.name.monkey.pulsemusic.SONG_GRID_STYLE
import code.name.monkey.pulsemusic.SONG_SORT_ORDER
import code.name.monkey.pulsemusic.START_DIRECTORY
import code.name.monkey.pulsemusic.SWIPE_ANYWHERE_NOW_PLAYING
import code.name.monkey.pulsemusic.SWIPE_DOWN_DISMISS
import code.name.monkey.pulsemusic.TAB_TEXT_MODE
import code.name.monkey.pulsemusic.TOGGLE_ADD_CONTROLS
import code.name.monkey.pulsemusic.TOGGLE_FULL_SCREEN
import code.name.monkey.pulsemusic.TOGGLE_HEADSET
import code.name.monkey.pulsemusic.TOGGLE_HOME_BANNER
import code.name.monkey.pulsemusic.TOGGLE_SUGGESTIONS
import code.name.monkey.pulsemusic.TOGGLE_VOLUME
import code.name.monkey.pulsemusic.USER_NAME
import code.name.monkey.pulsemusic.WALLPAPER_ACCENT
import code.name.monkey.pulsemusic.WHITELIST_MUSIC
import code.name.monkey.pulsemusic.extensions.getIntRes
import code.name.monkey.pulsemusic.extensions.getStringOrDefault
import code.name.monkey.pulsemusic.fragments.AlbumCoverStyle
import code.name.monkey.pulsemusic.fragments.GridStyle
import code.name.monkey.pulsemusic.fragments.NowPlayingScreen
import code.name.monkey.pulsemusic.fragments.folder.FoldersFragment
import code.name.monkey.pulsemusic.helper.SortOrder.AlbumSongSortOrder
import code.name.monkey.pulsemusic.helper.SortOrder.AlbumSortOrder
import code.name.monkey.pulsemusic.helper.SortOrder.ArtistAlbumSortOrder
import code.name.monkey.pulsemusic.helper.SortOrder.ArtistSongSortOrder
import code.name.monkey.pulsemusic.helper.SortOrder.ArtistSortOrder
import code.name.monkey.pulsemusic.helper.SortOrder.GenreSortOrder
import code.name.monkey.pulsemusic.helper.SortOrder.PlaylistSortOrder
import code.name.monkey.pulsemusic.helper.SortOrder.SongSortOrder
import code.name.monkey.pulsemusic.model.CategoryInfo
import code.name.monkey.pulsemusic.transform.CascadingPageTransformer
import code.name.monkey.pulsemusic.transform.DepthTransformation
import code.name.monkey.pulsemusic.transform.HingeTransformation
import code.name.monkey.pulsemusic.transform.HorizontalFlipTransformation
import code.name.monkey.pulsemusic.transform.NormalPageTransformer
import code.name.monkey.pulsemusic.transform.VerticalFlipTransformation
import code.name.monkey.pulsemusic.transform.VerticalStackTransformer
import code.name.monkey.pulsemusic.util.theme.ThemeMode
import code.name.monkey.pulsemusic.views.TopAppBarLayout
...
object PreferenceUtil {
    ...
    fun themeResFromPrefValue(themePrefValue: String): Int {
        return when (themePrefValue) {
            ...
            "dark" -> R.style.Theme_PulseMusic
            else -> R.style.Theme_PulseMusic
        }
    }
    ...
    // Bunu PreferenceUtil sınıfının/objesinin içine uygun bir yere ekle
    // PreferenceUtil.kt içinde
// --- 1. SALLAMA (SHAKE TO SKIP) ---
    var isShakeToSkipEnabled: Boolean
        get() = sharedPreferences.getBoolean("is_shake_to_skip_enabled", false)
        set(value) = sharedPreferences.edit().putBoolean("is_shake_to_skip_enabled", value).apply()

    // --- 2. TERS ÇEVİRME (FLIP TO PAUSE) ---
    var isFlipToPauseEnabled: Boolean
        get() = sharedPreferences.getBoolean("is_flip_to_pause_enabled", false)
        set(value) = sharedPreferences.edit().putBoolean("is_flip_to_pause_enabled", value).apply()

    // --- 3. TEMASSIZ KONTROL (AIR GESTURE) ---
    var isAirGestureEnabled: Boolean
        get() = sharedPreferences.getBoolean("is_air_gesture_enabled", false)
        set(value) = sharedPreferences.edit().putBoolean("is_air_gesture_enabled", value).apply()
}
