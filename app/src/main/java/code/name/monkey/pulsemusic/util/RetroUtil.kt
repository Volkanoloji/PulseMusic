...
object PulseUtil {
    ...
    fun getIpAddress(useIPv4: Boolean): String? {
        try {
                    ...
                    if (!addr.isLoopbackAddress) {
                        ...
                        if (sAddr != null) {
                            ...
                            if (useIPv4) {
                                ...
                                if (isIPv4) {
                                    Log.d("PulseUtil", "Using IP address: $sAddr")
                                    return sAddr
                                }
                            } else {
                                if (!isIPv4) {
                                    ...
                                    Log.d("PulseUtil", "Using IPv6 address: $processedAddr")
            ...
            Log.e("PulseUtil", "No suitable network interface found")
        } catch (e: Exception) {
            Log.e("PulseUtil", "Error getting IP address: ${e.message}")
        }
        return null
    }
}