package code.name.monkey.pulsemusic.views
...
import code.name.monkey.pulsemusic.databinding.CollapsingAppbarLayoutBinding
import code.name.monkey.pulsemusic.databinding.SimpleAppbarLayoutBinding
