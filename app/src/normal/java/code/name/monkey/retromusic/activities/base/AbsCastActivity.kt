...
import code.name.monkey.pulsemusic.cast.PulseSessionManagerListener
import code.name.monkey.pulsemusic.cast.PulseWebServer
import code.name.monkey.pulsemusic.helper.MusicPlayerRemote
import code.name.monkey.pulsemusic.service.CastPlayer
...
abstract class AbsCastActivity : AbsSlidingMusicPanelActivity() {
    ...
    private val webServer: PulseWebServer by inject()
    ...
    private val sessionManagerListener by lazy {
        object : PulseSessionManagerListener {
