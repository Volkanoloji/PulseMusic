package code.name.monkey.pulsemusic.cast

import androidx.core.net.toUri
import code.name.monkey.pulsemusic.cast.PulseWebServer.Companion.MIME_TYPE_AUDIO
import code.name.monkey.pulsemusic.cast.PulseWebServer.Companion.PART_COVER_ART
import code.name.monkey.pulsemusic.cast.PulseWebServer.Companion.PART_SONG
...
object CastHelper {
    ...
    fun Song.toMediaInfo(): MediaInfo? {
        ...
        val baseUrl: URL
        try {
            baseUrl = URL(CAST_URL_PROTOCOL, PulseUtil.getIpAddress(true), getCurrentServerPort(), "")
